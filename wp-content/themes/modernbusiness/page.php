                        ...
                        <div class="col-lg-8 col-xl-7 col-xxl-6">
                            <div class="my-5 text-center text-xl-start">
                                ...
                                <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xl-start">
                                   <?php if(pods_field_display('button1')): ?> <a class="btn btn-primary btn-lg px-4 me-sm-3" href="<?php echo pods_field_display('button1_url'); ?>"><?php echo pods_field_display('button1'); ?></a><?php endif; ?>

                                   <?php if(pods_field_display('button2')) : ?> <a class="btn btn-outline-light btn-lg px-4" href="<?php echo pods_field_display('button2_url'); ?>"><?php echo pods_field_display('button2'); ?></a><?php endif; ?>
                                </div>
                            </div>
                        </div>
    ...
    <div class="container px-5">
        <div class="row justify-content-center">
            <div class="col-lg-8 col-xxl-6">
                ...
                <h1 class="fw-bolder mb-3"><?php echo pods_field_display('heading2'); ?></h1>
                   <p class="lead fw-normal text-muted mb-4"><?php echo pods_field_display('subheding2'); ?></p>
